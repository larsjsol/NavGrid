...
protected:
	...
	float TileSize;
	FVector GetTopPathPoint() const { return ToWorldSpace(FVector(TileSize / 2, 0, BoxExtent.Z - 25)); }
	FVector GetBottomPathPoint() const { return ToWorldSpace(FVector(TileSize / 2, 0, -100)); }
